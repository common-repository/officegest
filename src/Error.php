...
class Error extends Exception
{
	...
	{
		$this->request = $request ?: OfficeGestCurl::getLog();
	...
	public function showError()
	{
		...
		include OFFICEGEST_TEMPLATE_DIR . 'Messages/DocumentError.php';
	}
	 ...
	 * Or tries to translate the error from OfficeGest API
	 * @return string
	 */
