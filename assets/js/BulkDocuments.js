...
jQuery(document).ready(function ($) {
    ...
    function BulkGenInvoice() {
        ...
        SelectedOrders = $('input[id^="officegest-pending-order-"]:checked');
    ...
    function HandleGenInvoiceSuccess(result) {
        ...
        if (result.valid) {
            $("#officegest-pending-order-row-" + GetNextInvoice()).remove();
    ...
    function OnMassSelectClick() {
        $(".officegest-pending-orders-select-all").click(function () {
            $('input[id^="officegest-pending-order-"]').not(this).prop('checked', this.checked);
        });
    }

    function OnIndividualSelectClick() {
        $('input[id^="officegest-pending-order-"]').click(function () {
            var AllSelected = true;
            var AllPendingOrders = $('input[id^="officegest-pending-order-"]');
            ...
            $(".officegest-pending-orders-select-all").prop('checked', AllSelected);
        });
    }
